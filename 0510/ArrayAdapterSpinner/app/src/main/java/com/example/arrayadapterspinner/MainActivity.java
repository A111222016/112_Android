    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String selectedDrink = drink.getSelectedItem().toString();
                String selectedTemp = temp.getSelectedItem().toString();

                // Generate the order message
                String orderMessage = "你的訂單: " + selectedDrink + " " + selectedTemp;

                // Display the order message in the TextView
                txv.setText(orderMessage);
